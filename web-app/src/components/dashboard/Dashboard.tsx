...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen relative bg-background text-foreground overflow-x-hidden">
            ...
            <div className="fixed inset-0 grid-pattern pointer-events-none opacity-40 dark:opacity-20" />
            <div className="pointer-events-none fixed inset-0">
                <div className="absolute top-[-10%] left-[-10%] h-[800px] w-[800px] rounded-full blur-[160px] animate-blob mix-blend-screen" style={{ background: "oklch(0.65 0.25 290 / 0.08)" }} />
                <div className="absolute bottom-[-10%] right-[-10%] h-[700px] w-[700px] rounded-full blur-[150px] animate-blob mix-blend-screen" style={{ background: "oklch(0.7 0.15 200 / 0.06)", animationDelay: "3s" }} />
            </div>

            <div className="relative z-10 w-full min-h-screen">
                {/* ==================== HEADER ==================== */}
                <header className="sticky top-0 z-40 border-b border-border/50 bg-background/50 backdrop-blur-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.1)]">
                    <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
                        <div className="flex items-center gap-3">
                            <h1 className="text-xl font-black tracking-tight bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent">PeerPool</h1>
